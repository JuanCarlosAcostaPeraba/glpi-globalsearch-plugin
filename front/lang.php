...
window.GLOBALSEARCH_LANG = {
    ...
    placeholder: <?= json_encode(__('Search tickets, projects (min. 2 characters)...', 'globalsearch'), JSON_UNESCAPED_UNICODE) ?>,
    help_text:   <?= json_encode(__('Search by ID (#123), phrases ("web server"), wildcards (imp*laser) or regex (/sw-[0-9]+/).', 'globalsearch'), JSON_UNESCAPED_UNICODE) ?>,
