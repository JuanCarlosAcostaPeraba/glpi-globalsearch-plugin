...
$LANG['globalsearch']['Search tickets, projects (min. 2 characters)...'] = 'Buscar tickets, proyectos (mín. 2 caracteres)...';
...
$LANG['globalsearch']['Search by ID (#123), phrases ("web server"), wildcards (imp*laser) or regex (/sw-[0-9]+/).'] = 'Busca por ID (#123), frases ("servidor web"), comodines (imp*laser) o regex (/sw-[0-9]+/).';
